...
CSR, i.e. the mconfigptr CSR.
NOTE: The mconfigptr CSR definition mandates an alignment of the base-address.
NOTE: The base-address cannot be zero.  Zero in mconfigptr CSR means that the
discovery data is not accessible through the CSR.
